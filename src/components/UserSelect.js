...
export default function UserSelect({l1, l2, l3, r1, r2, r3}) {
    ...
    <div className="overflow-clip h-auto"> 
        <div className="hidden md:flex flex-row w-full h-full align-middle">
            {/* Left Side */}
            <div className="w-full md:w-1/2 bg-primary flex-1 items-center justify-center cursor-pointer">
            ...
            {/* Right Side */}
            <div className="w-full md:w-1/2 h-full bg-info flex-1 items-center justify-center cursor-pointer" onClick={navigateToWorkspace}>
                <div className="text-white flex flex-col items-center justify-center w-full p-4">
        ...
        <div className="md:hidden flex-col w-full h-full">
            {/* Left Side */}
