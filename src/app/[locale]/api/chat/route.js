...
export async function POST(req) {
  try {
    ...
    const ragPrompt = [
      {
        role: 'system',
        content: `You are an AI assistant answering questions about Individualized Education Programs. Must output markdown code. Conveniently reference url links in the context if applicable. Must use simple elementary level words.
        context: ${docContext} 
