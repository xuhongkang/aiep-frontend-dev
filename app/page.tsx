        ...
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>AIEP-Chatbot</h1>
            </div>
          ...
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">Please type your questions or requests below. Responses are sourced from AIEP Knowledge Base and a link for further reading will be provided.</p>
        </div>
